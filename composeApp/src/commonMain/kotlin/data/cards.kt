...
val wildCardsList = listOf(
    Card(
        title = "comodín personalizable (uno tradicional y super mario)",
        shotUnit = """
        el jugador que tiro esta carta es que decide la cantidad de shots a tomar ejemplos:
